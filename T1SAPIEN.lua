--[[
    SAPIEN V1 Ultimate Script (Modificado para visibilidad en mobile)
    
    Funciones:
      • Menú móvil y arrastrable (260×400) para iPhone.
      • Speed (1–50) y Jump (1–115) con sliders y botones toggle.
      • PERFECTSHOT (Auto-Aim mejorado): 
            - Se muestra un AimCircle de radio 30 (más preciso).
            - Solo se activa cuando se detecta "ataque" (touch fuera del menú).
...
------------------------------------------------
-- Configurar ScreenGui como hijo de PlayerGui
------------------------------------------------
...
AntiDetectButton.Position = UDim2.new(0.25, 0, 0.77, 0)  -- Debajo de Heal
...
AntiDetectButton.MouseButton1Click:Connect(function()
    ...
    if antiBanEnabled then
        ...
        -- Aquí se podría agregar ofuscación u otras técnicas.

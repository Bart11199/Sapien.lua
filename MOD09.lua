--[[
    SAPIEN V1 Enhanced Cheat Script (Modificado - PerfectShot Avanzado)
    
    Funciones:
      • Menú móvil y arrastrable, optimizado para iPhone (menú pequeño y radar reducido).
      • Speed (1–50) y Jump (1–115) con slider y botón toggle.
      • PERFECTSHOT (Aim Lock Avanzado):
            - Se muestra un AimCircle transparente con bordes púrpuras (radio 30 px).
            - Se activa solo cuando se detecta ataque/disparo (touch fuera del menú).
            - La potencia (slider 1–30) define la rapidez del lock-on.
      • Unlimited Ammo, Heal Player, Damage Multipliers (activos mediante botones).
...
-- Insertar el ScreenGui en el PlayerGui para mejor visibilidad en mobile
...
local AIM_RADIUS = 30   -- radio reducido para mayor precisión

-- Variable global para multipliers de daño
_G.damageMultiplier = 1

-- Variable de control para PerfectShot: se activa solo al detectar ataque
...
ScreenGui.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.Touch then
        -- Si el toque NO es sobre el menú, consideramos que estás atacando
...
------------------------------------------------
-- Menú Principal Arrastrable (240×380)
------------------------------------------------
local MenuFrame = Instance.new("Frame")
MenuFrame.Name = "MenuFrame"
MenuFrame.Size = UDim2.new(0, 240, 0, 380)
...
------------------------------------------------
-- SECCIÓN: PERFECTSHOT (Auto-Aim Avanzado)
------------------------------------------------
...
-- Auto-Aim: se activa SOLO si PerfectShot está ON y se detecta que estás atacando.
